...
// 1. 季后赛对阵数据 (已修复变量名 seed1/seed2，并更新总决赛为 4-1)
const BRACKET_2026 = {
  west: {
    r1: [
      { top: "OKC", bot: "PHX", score: "4-0", seed1: 1, seed2: 8 },
      { top: "LAL", bot: "HOU", score: "4-2", seed1: 4, seed2: 5 },
      { top: "SAS", bot: "POR", score: "4-1", seed1: 2, seed2: 7 },
      { top: "DEN", bot: "MIN", score: "2-4", seed1: 3, seed2: 6 },
    ],
    r2: [
  ...
  east: {
    r1: [
      { top: "DET", bot: "ORL", score: "4-3", seed1: 1, seed2: 8 },
      { top: "CLE", bot: "TOR", score: "4-3", seed1: 4, seed2: 5 },
      { top: "BOS", bot: "PHI", score: "3-4", seed1: 2, seed2: 7 },
      { top: "NYK", bot: "ATL", score: "4-2", seed1: 3, seed2: 6 },
    ],
    r2: [
...
// 2. 常规赛排名数据 (已修正鹈鹕 no 和爵士 utah 的缩写)
const STANDINGS_DATA = {
  west: [
    { rank: 1, name: "OKC", abbr: "okc", wl: "64/18", pct: "78%" },
    { rank: 2, name: "SAS", abbr: "sas", wl: "62/20", pct: "75.6%" },
    { rank: 3, name: "DEN", abbr: "den", wl: "54/28", pct: "65.9%" },
    { rank: 4, name: "LAL", abbr: "lal", wl: "53/29", pct: "64.6%" },
    { rank: 5, name: "HOU", abbr: "hou", wl: "52/30", pct: "63.4%" },
    { rank: 6, name: "MIN", abbr: "min", wl: "49/33", pct: "59.8%" },
    { rank: 7, name: "PHX", abbr: "phx", wl: "45/37", pct: "54.9%" },
    { rank: 8, name: "POR", abbr: "por", wl: "42/40", pct: "51.2%" },
    { rank: 9, name: "LAC", abbr: "lac", wl: "42/40", pct: "51.2%" },
    { rank: 10, name: "GSW", abbr: "gsw", wl: "37/45", pct: "45.1%" },
    { rank: 11, name: "NO", abbr: "no", wl: "26/56", pct: "31.7%" },
    { rank: 12, name: "DAL", abbr: "dal", wl: "26/56", pct: "31.7%" },
    { rank: 13, name: "MEM", abbr: "mem", wl: "25/57", pct: "30.5%" },
    { rank: 14, name: "SAC", abbr: "sac", wl: "22/60", pct: "26.8%" },
    { rank: 15, name: "UTAH", abbr: "utah", wl: "22/60", pct: "26.8%" },
  ],
  east: [
    { rank: 1, name: "DET", abbr: "det", wl: "60/22", pct: "73.2%" },
    { rank: 2, name: "BOS", abbr: "bos", wl: "56/26", pct: "68.3%" },
    { rank: 3, name: "NYK", abbr: "nyk", wl: "53/29", pct: "64.6%" },
    { rank: 4, name: "CLE", abbr: "cle", wl: "52/30", pct: "63.4%" },
    { rank: 5, name: "TOP", abbr: "tor", wl: "46/36", pct: "56.1%" },
    { rank: 6, name: "ATL", abbr: "atl", wl: "46/36", pct: "56.1%" },
    { rank: 7, name: "76", abbr: "phi", wl: "45/37", pct: "54.9%" },
    { rank: 8, name: "ORL", abbr: "orl", wl: "45/37", pct: "54.9%" },
    { rank: 9, name: "CHA", abbr: "cha", wl: "44/38", pct: "53.7%" },
    { rank: 10, name: "MIA", abbr: "mia", wl: "43/39", pct: "52.4%" },
    { rank: 11, name: "MIL", abbr: "mil", wl: "32/50", pct: "39%" },
    { rank: 12, name: "CHI", abbr: "chi", wl: "31/51", pct: "37.8%" },
    { rank: 13, name: "BKN", abbr: "bkn", wl: "20/62", pct: "24.4%" },
    { rank: 14, name: "IND", abbr: "ind", wl: "19/63", pct: "23.2%" },
    { rank: 15, name: "WAS", abbr: "was", wl: "17/65", pct: "20.7%" },
  ]
};
    ...
    <div className="min-h-screen bg-[#0b0e11] text-white font-sans p-6 md:p-12">
      ...
      <main className="max-w-7xl mx-auto overflow-x-auto pb-32">
        <div className="text-center mb-24">
          ...
          <p className="text-zinc-500 font-bold uppercase tracking-[0.6em] text-[10px] mt-2 italic font-black italic text-orange-500">Jalen Brunson Finals MVP</p>
        </div>
          ...
          <div className="flex flex-col items-center px-6">
            <div className="relative border-4 border-orange-500 p-1 rounded-[4rem] bg-zinc-900 shadow-[0_0_80px_rgba(249,115,22,0.4)] animate-in zoom-in duration-700">
              <div className="bg-[#0b0e11] p-12 rounded-[3.8rem] text-center w-80 border border-white/10">
                <p className="text-[11px] font-black text-blue-500 uppercase tracking-[0.4em] mb-10 italic font-black italic text-orange-500">2026 WORLD CHAMPIONS</p>
      ...
      <section className="max-w-7xl mx-auto border-t border-zinc-800 pt-20 pb-40">
        <div className="text-center mb-16">
          <h3 className="text-4xl font-black italic uppercase tracking-tighter text-zinc-200 font-black italic">Regular Season <span className="text-blue-500">Standings</span></h3>
          <p className="text-zinc-600 text-[10px] font-bold uppercase tracking-[0.4em] mt-2 italic font-black italic">The Road to the Finals 2026</p>
        </div>
