...
// 1. NBA 官方 2025-26 赛季 15 人核心名单校对库 (覆盖 30 支队)
...
const TEAM_LEGACY: Record<string, any> = {
  "BOS": { championships: 18, bio: "凯尔特人是 NBA 历史冠军之王，2024 年夺得第 18 冠，绿军王朝底蕴深厚。" },
  ...
  "SAS": { championships: 5, bio: "圣安东尼奥马刺以完美的团队篮球和波波维奇的执教艺术闻名，文班亚马正开启新时代。" },
  ...
  "HOU": { championships: 2, bio: "休斯顿火箭曾创造奥拉朱旺时代的连冠辉煌，目前正致力于航天城的青年军重建。" },
  ...
  "OKC": { championships: 1, bio: "雷霆队拥有恐怖的天赋储备和选秀权，正迅速成为西部最具威胁的统治力量。" },
  ...
  "ATL": { championships: 1, bio: "亚特兰大老鹰始终保持着极高的进攻节奏和观赏性，是一支充满活力的南方劲旅。" },
  "WAS": { championships: 1, bio: "华盛顿奇才历史底蕴深厚，作为首都球队，目前正处于重构竞争力的关键期。" },
    ...
    >
      <div className="flex items-center gap-6 relative z-10">
        ...
        <div>
          ...
          <p className="text-[10px] text-zinc-500 font-bold uppercase tracking-widest mt-1">Access Roster Terminal →</p>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-[#0b0e11] text-white p-6 md:p-12 font-sans text-sm">
      ...
      {selectedTeam && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-3xl bg-black/95">
          <div className="bg-[#111317] border border-zinc-800 w-full max-w-4xl max-h-[90vh] rounded-[3rem] overflow-y-auto shadow-2xl relative animate-in zoom-in duration-500">
            ...
            <div className="sticky top-0 z-20 bg-zinc-900/90 backdrop-blur-md p-8 border-b border-white/10 flex justify-between items-center">
               <div className="flex items-center gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-blue-500 font-bold uppercase tracking-[0.2em] text-[10px] mt-2">Official 15-Man Roster • 2025-26</p>
                  </div>
               </div>
            ...
            <div className="p-10 space-y-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2 space-y-6">
                  <h4 className="text-[10px] font-black text-zinc-500 uppercase tracking-widest border-l-2 border-blue-500 pl-4">Team Bio</h4>
              ...
              <div className="space-y-8 pb-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {(OFFICIAL_ROSTERS[selectedTeam.abbreviation] || ["Loading Roster..."]).map((name: string, i: number) => (
                    <div key={i} className="bg-zinc-900/50 p-5 rounded-2xl border border-zinc-800 hover:border-zinc-500 transition-all flex items-center gap-4 group">
                      ...
                      <p className="text-white font-black uppercase text-[11px] truncate group-hover:text-blue-400 transition-colors">{name}</p>
                    </div>
                  ))}
                </div>
              </div>
